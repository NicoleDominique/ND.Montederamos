...
timeline
    ...
    2024 Q2 : SOC Tier 1 Role<br>Threat Hunting Fundamentals
    2024 Q3 : CySA+ Preparation<br>Cloud Security (AWS/Azure)
    2024 Q4 : CySA+ Certification<br>Detection Engineering
...
🔍 Threat Hunting	Learning	▰▰▰▱▱ 60%	TryHackMe, OpenCTI
🤖 Automation	Intermediate	▰▰▰▱▱ 60%	Python, PowerShell
☁️ Cloud Security	Beginner	▰▰▱▱▱ 40%	AWS, Azure
📊 Digital Forensics	Learning	▰▰▰▱▱ 60%	Autopsy, FTK
</div><!-- Animated Divider --><div align="center"> <img src="https://raw.githubusercontent.com/andreasbm/readme/master/assets/lines/rainbow.png" alt="divider" width="100%" height="30" /> </div>
📊 GitHub Statistics
